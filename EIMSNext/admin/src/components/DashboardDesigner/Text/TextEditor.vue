...
.dashboard-text-editor { position: relative; display: flex; flex-direction: column; width: 100%; min-height: 300px; height: 100%; background: var(--et-bg-container); }.dashboard-text-editor :deep(.w-e-toolbar) { position: absolute; left: 0; right: 0; bottom: calc(100% + 5px); z-index: 20; border: 1px solid var(--et-border-color); box-shadow: var(--et-shadow-overlay); }.dashboard-text-editor :deep(.w-e-text-container), .dashboard-text-editor :deep(.w-e-scroll) { flex: 1; min-height: 300px; overflow: auto; }.dashboard-text-editor :deep(.w-e-text-placeholder) { font-style: normal; }
</style>
