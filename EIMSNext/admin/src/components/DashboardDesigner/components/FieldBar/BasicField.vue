<template>
    <div>
        <el-popover v-model:visible="showTitleInput" :virtual-ref="triggerRef" trigger="contextmenu"
            placement="bottom-start" :offset="5" :show-arrow="false" width="200" :teleported="false">
        ...
        <el-dropdown :show-arrow="false" trigger="click" placement="bottom-start">
            <div ref="triggerRef" :key="field.title" class="item dimension-item forbid">
                <div class="item-text" :class="isDeleted ? 'style-red' : ''">
                    <et-icon icon="el-arrowDown" :color="isDeleted ? '#eb5050' : '#fff'"
                        style="margin: 0 5px;"></et-icon>
