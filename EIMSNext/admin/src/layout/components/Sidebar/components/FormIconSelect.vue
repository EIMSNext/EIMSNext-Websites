<template>
  <div class="icon-select" :style="{ width: width }">
...
const selectedColor = ref<string>(colorOptions[colorOptions.length - 1].value);
...
const selectIcon = (icon: string) => {
  // Emit both icon and its associated color for parent sync
  emit("ok", { icon, iconColor: selectedColor.value });
};
