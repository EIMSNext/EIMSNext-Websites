import { maker } from "@eimsnext/form-render-elplus";
...
export default function mock() {
  return [
    ...
    maker
      ...
      .control([
        ...
        },
        {
          ...
          child: true,
          rule: [
            maker.create("template").children(["prepend"]).slot("prepend"),
          ],
        },
      ])
      .on({
    ...
    //upload 上传组件
    maker.upload("轮播图", "pic", ["http://form-create.com/logo.png"]).props({
    ...
    //frame 框架组件
    maker
      .frame("素材", "fodder", ["http://form-create.com/logo.png"])
      .props({
        src: "/iframe.html",
        maxLength: 0,
        type: "image",
