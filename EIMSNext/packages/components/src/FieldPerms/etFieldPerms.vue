          ...
          <div class="check-item">
            ...
            <div class="field-view-col">
              <el-checkbox
                ...
                size="large"
                @change="
                  (val: boolean) => handlePermChange(item, 'visible', val)
                "
              />
            </div>
            <div class="field-edit-col">
              <el-checkbox
                ...
                size="large"
                @change="
                  (val: boolean) => handlePermChange(item, 'editable', val)
                "
              />
  ...
  props.fields.forEach((x) => {
    if (x.type === FieldType.TableForm) {
      if (x.columns && x.columns.length > 0) {
        ...
        listItems.push(li);
        fixedModelValue.value.push({
          id: li.id,
          visible: li.visible,
          editable: li.editable,
          tableInsert: li.tableInsert,
          tableEdit: li.tableEdit,
          tableDelete: li.tableDelete,
        });
