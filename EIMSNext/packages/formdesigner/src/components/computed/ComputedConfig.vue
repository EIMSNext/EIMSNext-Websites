      ...
      >
        <el-tab-pane name="condition">
          <template #label>
            {{
              type === "linkage"
                ? t("computed.value.title")
                : t("computed.condition")
            }}
                    ...
                    <template #default="{ node, data }">
                      ...
                      >
                        <div>
                          ...
                          <span>{{
                            (data.label || "").trim() || getTitle(data.rule)
                          }}</span>
                        </div>
                        <span
                          class="_fd-comp-id"
                ...
                <el-main>
                  <div class="_fd-comp-info" v-if="formulaInfo || err">
                    ...
                    <div v-if="formulaInfo">
                      {{ t("computed.formulaInfo") }}: {{ formulaInfo }}
                    </div>
                    <div v-if="formulaExample">
                      {{ t("computed.formulaExample") }}: {{ formulaExample }}
                    </div>
                    <div v-if="err" style="color: #f56c6c">
                      {{ t("validate.message") }}: {{ err }}
                    </div>
                  </div></el-main
                >
              </el-container>
