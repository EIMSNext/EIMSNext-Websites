<template>
    <div class="_fd-style-config">
        ...
        <DisplayInput v-model="display" @change="onInput"/>
...
import { toCase,toLine } from "@eimsnext/form-render-core";
    ...
    methods: {
        ...
        onInput() {
            ...
            const style = {
                ...
                ...this.space, ...this.size, ...this.border, ...this.display, ...this.font, ...overStyle
            }
            Object.keys(style).forEach(k => {
                if (isNull(style[k])) {
                    delete style[k];
