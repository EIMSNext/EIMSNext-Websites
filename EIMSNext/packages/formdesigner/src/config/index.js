...
import tableForm2 from './rule/tableForm2';
...
import tableFormColumn2 from './rule/tableFormColumn2';
...
const ruleList = [
    input, textarea, password, mention, segmented, number, radio, checkbox, select, _switch, rate, time, timeRange, slider, date, dateRange, color, cascader, upload, transfer, tree, treeSelect, city, editor, dataTable, id, signaturePad,
    group, subForm, stepForm, value, tableForm, tableForm2, tableFormColumn,tableFormColumn2, nestedTableForm, nestedSubTableForm, infiniteTableForm,
    slot, json, formItem,
    alert, button, tag, title, text, html, statistic, divider, link, tooltip, watermark, image, audio, video, avatar, barCode, iframe, qrCodeBox,
    lineChart, areaChart, barChart, stripeChart, pieChart, funnelChart, gaugeChart, radarChart, scatterChart, customChart,
    row, table, inlineForm, flex2, flex, cell, tabs, space, card, collapse, descriptions, dialog, drawer,

    col3, col4, table43, chineseAmount, duration,

    col, tabPane, collapseItem, descriptionsItem, stepFormItem
];
