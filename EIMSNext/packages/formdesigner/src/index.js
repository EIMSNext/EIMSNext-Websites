...
import DividerStyleSelect from "./components/style/DividerStyleSelect.vue";
...
import StaticOptionsConfig from "./components/StaticOptionsConfig.vue";
...
import QueryFilterConfig from "./components/QueryFilterConfig.vue";
...
designerForm.component("StaticOptionsConfig", StaticOptionsConfig);
...
designerForm.component("DividerStyleSelect", DividerStyleSelect);
...
designerForm.component("SelectionProcessConfig", SelectionProcessConfig);
designerForm.component("DisplayFieldsConfig", DisplayFieldsConfig);
designerForm.component("FillFieldsConfig", FillFieldsConfig);
designerForm.component("QueryFilterConfig", QueryFilterConfig);
designerForm.component("FormSelect", FormSelect);
