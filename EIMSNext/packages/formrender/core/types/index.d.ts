...
export type Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> = BaseRule<
  OptionAttrs,
  CreatorAttrs,
  RuleAttrs,
  ApiAttrs
...
export declare type Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> =
  BaseApi<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> & ApiAttrs;

declare type FormCreateFactory<
  MakerAttrs,
  OptionAttrs,
  CreatorAttrs,
  RuleAttrs,
...
export interface FormCreateFactoryConfig<
  MakerAttrs,
  OptionAttrs,
  CreatorAttrs,
  RuleAttrs,
...
> {
  ...
  register(
    name: string,
    effect:
      | Effect<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
      | ((fc: Object) => void)
  ): void;

  register(
    effect: Effect<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  ): void;
  ...
  use(
    install:
      | Install<MakerAttrs, OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
      | {
          install: Install<
            MakerAttrs,
            OptionAttrs,
  ...
  getApi(
    name: string
  ): Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> | undefined;
  ...
  extendApi(
    fn: (api: Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>) => Object
  ): void;
...
type RuleChildrenFn<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> = (
  ...
  | FormRule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>[]
  | Promise<FormRule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>[]>;
...
export interface BaseRule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  extends VNodeData {
  field?: string;
  key?: string;
  name?: string;
  ...
  inject?: any;
  slotUpdate?: (
    arg: PropArg<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  ) => void;

  validate?: Object[];
  children?: Array<
    RuleChildren<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  >;
...
export declare interface CreatorFactory<
  OptionAttrs,
  CreatorAttrs,
  RuleAttrs,
  ApiAttrs,
> {
  (
    ...
    init:
      | Object
      | ((
          m: Creator<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
        ) => Creator<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>)
...
export class BaseCreator<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> {
  ...
  children(
    prop: Array<RuleChildren<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>>
  ): this;

  control(
    prop: Control<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>[]
  ): this;
...
export interface BaseApi<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> {
  ...
  submit(
    ...
    fail?: (api: Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>) => void
  ): Promise<any>;
  ...
  updateRule(rules: {
    [field: string]: Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>;
  }): void;
  ...
  getParentRule(
    id: string | Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  ): undefined | Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>;
  ...
  getParentSubRule(
    field: string | Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>
  ): Rule<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs> | undefined;
  ...
  nextTick(
    fn: (api: Api<OptionAttrs, CreatorAttrs, RuleAttrs, ApiAttrs>) => void
  ): void;
  ...
  watchFetch(
    opt: FetchOption,
    success: (res: any, change: boolean) => void,
    error: Function
  ): Function;

  getData(id: string, defaultValue?: any): any;
  watchData(
    fn: (get: (id: string, defaultValue?: any) => any, change: boolean) => void
  ): () => Function;
