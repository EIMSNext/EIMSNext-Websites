...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const resolveRecordValue = (record, path) => {
      ...
      if (
        record.data &&
        Object.prototype.hasOwnProperty.call(record.data, path)
      ) {
    ...
    const buildDisplayTagsFromForm = () => {
      ...
      return displayRules.map((rule) => {
        const matchedFillRule = fillRules.find(
          (fillRule) =>
            fillRule?.field?.value === rule.value && fillRule?.targetField
        );
      ...
      if (selectedRecord.value) {
        ...
        if (fillRules.length > 0 && props.formCreateInject) {
          ...
          try {
            ...
            if (
              props.formCreateInject.api &&
              props.formCreateInject.api.setFormData
            ) {
      ...
      return (
        <div style={{ width: "100%" }}>
          ...
          {displayTags.length === 0 && editable && (
            <div style={{ padding: "8px 0", color: "#909399" }}>暂无数据</div>
          )}
            ...
            <div class="form-selected-data-dialog">
              <div class="form-selected-data-dialog-content">
                <div class="form-selected-data-dialog-header">
                  <h3>选择数据</h3>
                  <button
                    class="form-selected-data-dialog-close"
                          ...
                          >
                            <button
                              ...
                              style={{
                                ...
                                marginRight: "5px",
                                backgroundColor:
                                  currentPage.value === 1 ? "#f5f7fa" : "#fff",
                                cursor:
                                  currentPage.value === 1
                                    ? "not-allowed"
                                    : "pointer",
