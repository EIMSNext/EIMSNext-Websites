import { toArray, Mitt } from "@eimsnext/form-render-core";
...
export default defineComponent({
      ...
      return (
        <ElInput
          ...
          v-slots={{
            ...
            suffix: () =>
              this.fileList.length && !this.disabled ? (
                <ElIcon
      ...
      return (
        <div>
          {closeBtn ? (
            ...
            >
              {closeBtnText || this.formCreateInject.t("close") || "关闭"}
            </ElButton>
          ) : null}
          {okBtn ? (
            <ElButton
            ...
            >
              {okBtnText || this.formCreateInject.t("ok") || "确定"}
            </ElButton>
          ) : null}
        </div>
      );
  ...
  render() {
    ...
    return (
      <div class={{ "_fc-frame": true, "_fc-disabled": this.disabled }}>
        {node}
        <ElDialog
          appendToBody={true}
