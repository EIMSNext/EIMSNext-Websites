export default {
  ...
  comp: {
    ...
    memberSelect: {
      ...
      members: "Members",
      searchMember: "Search member name or code",
      searchDepartment: "Search department name or code",
      searchHint: "Search to quickly find results",
      viewAllMembers: "View all members",
      departmentRoot: "Departments",
      enterDepartment: "Open sub-departments",
      noResults: "No search results",
      noSelectableData: "No selectable data",
      noCurrentUser: "Current user is unavailable",
      noCurrentDepartment: "Current department is unavailable",
    ...
    addEditEmployeeGroupCategory: {
      ...
      cannotDeleteWithEmployeeGroups: "Cannot delete: group contains employeeGroups",
    },
    addEditEmployeeGroup: {
      employeeGroupCategory: "Employee group category",
      employeeGroupName: "Employee group name",
      employeeGroupNamePlaceholder: "Please enter employee group name",
      employeeGroupDesc: "Employee group description",
      employeeGroupDescPlaceholder: "Please enter employee group description",
      editEmployeeGroup: "Edit EmployeeGroup",
      employeeGroupNameRequired: "Employee group name is required",
    },
    addEditApp: {
      appName: "App Name",
  ...
  admin: {
    ...
    workbench: {
      ...
      chartNotConfigured: "Unified configuration is not required. Members can add commonly-used charts by themselves. ",
      favoritesEmpty: "No shared setup is required. Members can favorite frequently used apps, forms or dashboards themselves.",
    ...
    appPage: {
      ...
      newDashboardDesc: "For presenting business data and key metrics in one place.",
    },
    apiKeyMgmt: {
      title: "API Key",
    ...
    formListView: {
      ...
      allFormDataPermissionGroups: "All Permission Groups",
      scopeTitle: "View Usage Scope",
      permissionGroups: "Data Permission Groups",
    ...
    printDesigner: {
      ...
      internalQrCode: "Internal Data QR Code",
      externalQrCode: "External Data QR Code",
      printOperator: "Print Operator",
      printTime: "Print Time",
      approvalSequence: "Sequence",
      approvalTime: "Approval Info.Approval Time",
      approvalNodeName: "Approval Info.Node Name",
      approvalApprover: "Approval Info.Approver",
      approvalContent: "Approval Info.Content",
      approvalResult: "Approval Info.Result",
    ...
    dashboardDesigner: {
      ...
      quickFilterSettings: "Quick Filter Settings",
      quickFilterOptions: "1. Set quick filter options",
      quickFilterConditions: "2. Set conditions for the selected option",
      addQuickFilterOption: "Add quick filter option",
      addFilterCondition: "Add filter condition",
      quickFilterOptionName: "Quick filter option name",
      untitledQuickFilterOption: "Untitled quick filter option",
      filterCondition: "Filter condition",
      noFilterCondition: "No filter conditions",
      selectQuickFilterOption: "Select a quick filter option",
      quickFilterConditionIncomplete: "Configure a filter field for every target component",
      ...
      image: "Images",
      imageTip: "Supports jpg, jpeg, png, and gif. Maximum 5 MB per image.",
      noImage: "No images",
      imageFit: "Fill Mode",
      imageFitContain: "Original Size",
      imageFitCover: "Cover",
      imageFitFill: "Stretch",
      imageAutoPlay: "Auto Play",
      imageTypeError: "Only jpg, jpeg, png, and gif images are supported",
      imageSizeError: "Image size cannot exceed 5 MB",
      imageLimitError: "A maximum of {limit} images can be uploaded",
    ...
    dashboardChartDesigner: {
      ...
      progressConfig: "Progress Settings",
      lineConfig: "Line Style",
      barConfig: "Bar Chart Style",
      showMetricName: "Show Metric Name",
      showActualValue: "Show Actual Value",
      showTargetValue: "Show Target Value",
      showPercent: "Show Percentage",
      decimalPlaces: "Decimal Places",
      targetMetric: "Target Metric",
      manualTarget: "Manual Target",
      selectTargetMetric: "Select target metric",
      lineType: "Line Type",
      lineNormal: "Normal",
      lineCurve: "Smooth",
      showDataPoint: "Show Data Points",
      xAxisHorizontal: "Horizontal",
      xAxisTilt: "Tilted",
      xAxisVertical: "Vertical",
      showAllXAxisLabels: "Show All X Labels",
      showDataZoom: "Show Data Zoom",
      yAxisTitle: "Y Axis Title",
      yAxisMin: "Minimum",
      yAxisMax: "Maximum",
      valueAxisTitle: "Value Axis Title",
      valueAxisMin: "Value Axis Minimum",
      valueAxisMax: "Value Axis Maximum",
      showDataLabel: "Show Data Labels",
      labelAdjust: "Auto Adjust",
      labelHide: "Hide Overlap",
      labelStagger: "Stagger Labels",
    ...
    department: {
      ...
      messages: {
        ...
        employeeGroupRequired: "Employee group is required",
    ...
    tenantAdminGroup: {
      ...
      contactDesc: "Set contact management permissions (viewable/manageable departments and employee groups) for members",
      sysTenantAdminGroup: "System Admin Group",
      ...
      optionalEmployeeGroup: "Available employee groups",
      allDepts: "All Departments",
      partialDepts: "Selected Departments",
      allEmployeeGroups: "All employee groups",
      partialEmployeeGroups: "Selected employee groups",
      internalDept: "Internal Departments",
      internalEmployeeGroup: "Internal employee groups",
      ...
      editName: "Edit Name",
      delete: "Delete",
      groupDesc: "Admin groups organize standard admin groups by department/employee group for delegated management",
      cannotDeleteWithSubgroups: "Cannot delete: contains subgroups",
      missingSysTenantAdminGroup: "Missing system admin group. Please contact your administrator.",
  ...
  workflow: {
    ...
    formFieldPermissions: "Field Permissions",
    ...
    returnableNodes: "Returnable node",
    returnPrevious: "Previous node",
    returnStart: "Flow start node",
    returnSpecified: "Specified node",
    selectReturnTargetNode: "Please select a return node",
  ...
  eventFlow: {
    ...
    untitledEventFlow: "Untitled Automation",
    selectTriggerType: "Please select a trigger type",
    eventFlowName: "Name",
    newEventFlow: "New Automation",
    newEventFlowDialog: "New Automation",
  ...
  dash: {
    ...
    limitation: {
      progress: "0 dimensions, 1 metric, 1 target metric",
  ...
  props: {
    ...
    content: "Content",
    color: "Color",
    recommendedColor: "Recommended colors",
  ...
  publicpublish: {
    ...
    extlinkLink: "Link",
    extlinkDesc: "Add extension values to generate distinct links and identify data sources. Extension values support Chinese characters, letters, numbers, underscores, hyphens, and percent signs.",
    embed: "Embed",
    embedDesc: "Provide the link and reference code to embed the public query page in your website",
    formEmbedDesc: "Provide the link and reference code to embed the public form page in your website",
    embedLink: "Embed Link",
