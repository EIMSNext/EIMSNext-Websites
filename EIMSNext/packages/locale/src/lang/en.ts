export default {
  ...
  admin: {
    ...
    dashboardChartDesigner: {
      ...
      targetValueHint: "Click to enter a target value, or drag a field here to add a target metric",
      manualTargetLabel: "Target Value ({value})",
